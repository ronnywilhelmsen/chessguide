...
// Suppressed output CLASSES. The surface lists these as categories only and
// NEVER renders their content. Nothing in this skeleton can produce them.
...
// Human-readable labels for the suppressed-class list (category names only).
...
export const ALL_SUPPRESSED_OUTPUT_CLASSES: SuppressedOutputClass[] = [
  ...
  SuppressedOutputClass.RAW_CV_DATA,
];
